<div class="modal fade" id="modalActividad" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmActividad" onsubmit="return registrarActividad()" method="post">
                    <div class="form-group row">
                        <label for="fecha" class="col-sm-2 col-form-label">Fecha</label>
                        <div class="col-sm-10">
                            <input type="type=" name="fecha" class="form-control form-control-sm" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="actividad" class="col-sm-2 col-form-label">Actividad</label>
                        <div class="col-sm-10">
                            <textarea type="text" class="form-control form-control-sm" name="actividad"
                                required></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select required name="periodo" class="form-control form-control-sm">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select name="color" required id="selectColor" class="form-control form-control-sm">
                                <option selected disabled value="">Seleccione</option>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-sm text-white">
                                <i class="fa fa-save"></i> Crear</button>
                        </div>
                    </div>
                </form>
            </div>
