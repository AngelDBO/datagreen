                        ...
                        <div class="col-md-12">
                            <div class="au-breadcrumb-content">
                                ...
                                <button class="btn text-white btn-modal" data-toggle="modal"
                                    data-target="#modalRegistroCategoria">
...
<!-- Modal -->
<?php require_once 'modal/categoria/modal_registrar_categoria.php'?>
<!-- Modal update-->
<?php require_once 'modal/categoria/modal_editar_categoria.php'?>
<!-- Jquery JS-->
