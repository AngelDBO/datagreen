...
<body>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item active">Categorias</li>
                                        </ul>
                                    </div>
                                    <button class="btn text-white btn-modal" data-toggle="modal" data-target="#modalRegistroCategoria">
                                ...
                                <div class="table-responsive m-b-30">
                                    <div class="card">
                                        <div class="card-header pt-2 pb-2">
                                            <h5 class="card-title text-white">Categorias</h5>
                                        </div>
                                        <div class="card-body">
                                            <table class="table table-borderless table-hover nowrap dt-responsive" id="tablaCategoria">
    ...
    <!-- Modal update-->
    <div class="modal fade" data-backdrop="static" id="updateCategoria" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header pt-2 pb-2">
                    <h5 class="modal-title text-white" id="exampleModalLongTitle">Actualizar categoria</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" class="text-white">&times</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="frmActualizarCategoria" onsubmit="return actualizarCategoria()" method="post" autocomplete="off">
                        <input type="hidden" readonly name="IDregistroU" id="IDregistroU">
                        <div class="form-group">
                            <label for="nombreCategoriaU" class="control-label text-body">Nombre categoria</label>
                            <input type="text" class="form-control form-control-sm" id="nombreCategoriaU" name="nombreCategoriaU">
                        </div>
                        <div>
                            <button type="submit" class="btn text-white btn-sm btn-modal">
                                <i class='fas fa-save'></i> Guardar
