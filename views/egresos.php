                ...
                <div class="modal-body">
                    <form id="frmIngreso" onsubmit="return registrarEgreso()" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" name="terceroEgreso" id="terceroEgreso"
                                required>
                            </select>
                        </div>
                        <div class="form-group">
    ...
    <div class="modal fade" data-backdrop="static" id="editarEgreso" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content rounded-right rounded-left">
                ...
                <div class="modal-body">
                    <form id="frmActualizarIngreso" onsubmit="return actualizarEngreso()" method="post"
                        autocomplete="off">
