...
<?php require_once 'layouts/header.php'?>
    ...
    <div class="page-wrapper">
        <?php require_once 'layouts/menu_principal.php'?><!-- MENU PRINCIPAL-->
        <div class="page-container2">
            <!-- CONTENIDO-->
            <?php require_once 'layouts/menu_control.php'?><!-- MENU PRINCIPAL-->
            <?php require_once 'layouts/menu_mobile.php'?><!--MENU MOBIL-->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button type="button"
                                            ...
                                            onclick="obtenerArchivosCompartidos()"><i
                                                class="fas fa-share-alt-square"></i>
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <a class="dropdown-item" href="#"><i
                                                        class="zmdi zmdi-collection-text"></i> Documentos</a>
                                                <a class="dropdown-item" href="#"><i
                                                        class="zmdi zmdi-collection-image-o"></i> Imagenes</a>
                                                <a class="dropdown-item" href="#"><i
                                                        class="zmdi zmdi-collection-video"></i> Videos </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
